...
export function MultiplicationMountain({ onCorrect, onIncorrect }: Props) {
  ...
  const mountainEmoji = height >= 10 ? "🏔️⛳" : "🏔️";

  return (
    <div className="flex flex-col items-center gap-6 py-6">
      <div className="text-4xl">{mountainEmoji}</div>
      <p className="text-lg font-medium">
        Climb the mountain! Height: {height * 10}ft {height >= 10 && "🎉 Summit reached!"}
      </p>
      ...
      {feedback === "incorrect" && (
        <div className="text-center animate-fade-up">
          <p className="text-red-400 font-bold text-lg">❌ The answer was {question.answer}</p>
